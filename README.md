This repo contains all the working code files for the project as well as depracated ones.

### Things to note
1. The directory `MEE_202_CameraWebServer` contains the depracated files for the ESP32-S3-CAM.
